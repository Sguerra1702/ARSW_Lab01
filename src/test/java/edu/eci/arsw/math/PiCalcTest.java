...
public class PiCalcTest {
    ...
    @Test
    public void piGenTestForOneThread() throws Exception {
        ...
        for (int start = 0; start < expected.length; start++) {
            for (int count = 0; count < expected.length - start; count++) {
                byte[] digits = new PiDigits().getDigits(start, count, 1);
    ...
    @Test
    public void piGenTestForTwoThreads() throws Exception {
        ...
        for (int start = 0; start < expected.length; start++) {
            for (int count = 0; count < expected.length - start; count++) {
                byte[] digits = new PiDigits().getDigits(start, count, 2);
                assertEquals(count, digits.length);
    ...
    @Test
    public void piGenTestForThreeThreads() throws Exception {
        ...
        for (int start = 0; start < expected.length; start++) {
            for (int count = 0; count < expected.length - start; count++) {
                byte[] digits = new PiDigits().getDigits(start, count, 3);
                assertEquals(count, digits.length);
